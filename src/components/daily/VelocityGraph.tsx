        ...
        >
                ...
                <div className="h-[160px]">
                    <ResponsiveContainer width="100%" height="100%">
                        <BarChart data={data}>
                            ...
                            />
                            <YAxis hide />
                            <Tooltip {...TOOLTIP_STYLE} formatter={(val: any /* eslint-disable-line @typescript-eslint/no-explicit-any */) => [`$${formatNumber(Number(val))}`, "Spent"]} />
                            <Bar
                                dataKey="amount"
                                fill="#6366f1"
                                radius={[4, 4, 0, 0]}
            ...
            {total > 0 && (
                <p className="text-xs text-muted-foreground mt-2 text-center">
                    ${formatNumber(total)} total · shows where in the day you spend most
                </p>
            )}
        </motion.div>
    );
