...
export default function DashboardLayout({
    ...
    return (
        <div className="relative flex h-screen w-full overflow-hidden bg-background bg-grid">
            ...
            <div className="hidden md:block z-10 p-4 pr-0 text-foreground">
                <Sidebar />
            </div>

            <div className="flex flex-1 flex-col overflow-hidden z-10">
                <header className="flex h-16 sm:h-20 items-center justify-between px-4 sm:px-6 lg:px-8 bg-transparent border-b border-border">
                    ...
                    <div className="flex items-center gap-4">
                        <ThemeToggle />
                        <div className="w-10 h-10 rounded-full bg-muted border border-border flex items-center justify-center text-foreground">
                            <span className="text-xs font-bold">{initials}</span>
                        </div>
                    </div>
                </header>

                <main className="flex-1 overflow-y-auto overflow-x-hidden p-4 sm:p-6 lg:p-8 text-foreground">
